...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    cur_city = make_city('current_city',lat, lon)

    distance_a = distance(cur_city, city_a)
    distance_b = distance(cur_city, city_b)
...
def riffle(deck):
    ...
    """
    "*** YOUR CODE HERE ***"
    return [deck[i] if i%2 == 0 
            else deck[len(deck)//2+1:][i-1]
