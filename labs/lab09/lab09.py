...
def subseqs(s):
    ...
    if s == []:
       ...
       return [[s[0]] + x for x in subseqs(s[1:])] + subseqs(s[1:])
...
def num_trees(n):
    ...
    *   *        *       *
    ...
    if n == 2:
        return 1 
    return num_trees(n-1) + num_trees(n-1)
